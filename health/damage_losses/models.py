...
class DlSessionKeys(models.Model):
    ...
    province = models.ForeignKey(Province, db_column='province', related_name='hea_province', blank=True, null=True)
    district = models.ForeignKey(District, db_column='district', related_name='hea_district', blank=True, null=True)
