	...
	$scope.fetchDlData = function() {
		...
		$http({
			...
			angular.forEach($scope.provincenames.sort(), function(value, key) {
				...
				console.log('testing',$scope.dlWaterSumNat.water_supply.Table_7[value].DlcwNumAfNational[0]);
                ...
                var totalCommercialDamages = ($scope.dlWaterSumNat.water_supply.Table_7[value] ? ($scope.dlWaterSumNat.water_supply.Table_7[value].DlcwDmgNational[0].sum ? $scope.dlWaterSumNat.water_supply.Table_7[value].DlcwDmgNational[0].sum : 0) : 0);

                var totalRuralDamage = ($scope.dlWaterSumNat.water_supply.Table_7[value] ? ($scope.dlWaterSumNat.water_supply.Table_7[value].DlRuralDmgNational[0].tot_damages ? $scope.dlWaterSumNat.water_supply.Table_7[value].DlRuralDmgNational[0].tot_damages : 0) : 0);

                var totalCommercialLossYear1 = 0;
                totalLossYear1 = ($scope.dlWaterSumNat.water_supply.Table_7[value]? ($scope.dlWaterSumNat.water_supply.Table_7[value].DlcwLosNational[0].tot_los_year1 ? $scope.dlWaterSumNat.water_supply.Table_7[value].DlcwLosNational[0].tot_los_year1 : 0) : 0);
                ...
                var totalRuralLosses = ($scope.dlWaterSumNat.water_supply.Table_7[value].DlRuralLosNational ? ($scope.dlWaterSumNat.water_supply.Table_7[value].DlRuralLosNational[0].tot_los ? $scope.dlWaterSumNat.water_supply.Table_7[value].DlRuralLosNational[0].tot_los : 0) : 0);
