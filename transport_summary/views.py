...
def dl_trns_sumr_distr(request):
    ...
    return render(request, 'summary_damage_losses_transportation_sector_district.html', context)
...
def dl_trns_sumr_provn(request):
    ...
    return render(request, 'summary_damage_losses_transportation_sector_province.html', context)
...
def dl_trns_sumr_natal(request):
    ...
    return render(request, 'summary_damage_losses_transportation_sector_nationwide.html', context)
